...
def build_inference_prompt(new_comp_overview: str,
    ...
    Please generate a list of new data features that are likely to work well for this new competition. For each feature, provide a short explanation of why it may be useful, referencing relevant techniques if needed.
...
def ask_rag_for_new_competition(new_comp_overview: str, 
                                new_comp_data_desc: str):

    similar_docs = retrieve_relevant_docs(new_comp_overview)

    prompt = build_inference_prompt(new_comp_overview,
                         new_comp_data_desc,
                         similar_docs)
